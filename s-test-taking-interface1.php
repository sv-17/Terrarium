...
<html lang="en">
  <head>
    <title>Terrarium | TestTakingInterface</title>
    <meta
      property="og:title"
        ...
        <div class="-test-taking-interface-container01">
          <div class="-test-taking-interface-container02">
            ...
            <div class="-test-taking-interface-container05">
              ...
              <?php
                $tst_comp=$_SESSION['comp_name'];
                $sql = "select * from question_pool where company='$tst_comp'";
                ...
                <form method="post">
                <div class="ques">
                <span class="-test-taking-interface-text09"><?php echo $_SESSION['testname']; ?></span><br><br>
                <?php
                ...
                header("Location: s-test-submission1.php");
              }
              ob_end_flush();
                ?>
            </div>
