...
if(isset($_POST['change_button'])){
  ...
  if ($old_entered != $_SESSION['password']){
  ...
  elseif ($new_pass != $new_pass_conf){
    ...
    $update_query = "UPDATE user_details SET password = '$new_pass' WHERE username = '".$_SESSION['username']."'";
    mysqli_query($conn, $update_query);
    $_SESSION['password'] = $new_pass;
    echo '<script type="text/javascript">';
    echo 'window.addEventListener("load", () => {swal({ title: "Success!", text: "Password updated successfully", type: "success", confirmButtonText: "Okay" })})';
    echo '</script>';
  }
  ...
  <body>
    <div>
      ...
      <div class="s-change-password-container">
        ...
        <form role="form" method = "post" action="login_password.php">
        <div class="s-change-password-container1">
          <div class="s-change-password-container2">
            <h1 class="s-change-password-text4">CHANGE PASSWORD</h1>
            <input
              type="password"
              name = "old_pass"
              required=""
