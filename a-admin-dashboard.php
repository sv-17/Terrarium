...
<html lang="en">
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
    <div>
      <link href="./a-admin-dashboard.css" rel="stylesheet" />
      ...
      <div class="-quiz-instructions-container">
        ...
        <div class="-quiz-instructions-container1">
          <img src="https://sales.webtel.in/images/Login-page-character1.png" height="70%">
            <div id="outer">
                <div class="inner">
                          <form action="quesapprove.php" target="_blank">
                               <button type="submit">Question Approval</button></div>
                          </form>
                <div class="inner">
                          <form action="f-test-setting-environment.php" target="_blank">
                      <button type="submit">Create Assessment</button></div>	
                          </form>
                      </div>
        </div>
    <script
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></scrip
