...
$query = "SELECT * FROM user_details WHERE username <> 'admin' order by rating DESC";
$result = $conn->query($query);

$query = "SELECT * FROM user_details WHERE username <> 'admin' order by contrib_rating DESC";
$result_cont = $conn->query($query);
?>
<html lang="en">
  <head>
    <title>Terrarium | Leaderboard</title>
    <meta
      property="og:title"
      ...
      <div class="-quiz-instructions-container">
        ...
        <div class="companydetails">
            <div class="logocompany">
                <img class="imglogo" src=https://cdn-icons-png.flaticon.com/512/3150/3150116.png>
            </div>
            <div class="">
                <p class="datacompany"> LEADERBOARD </p>
            </div>
        </div>
        <div class="modalc">
        <button class="tablink" onclick="openPage('Home', this, '#ebebeb')" id="defaultOpen">Users Leaderboard</button>
        <button class="tablink" onclick="openPage('News', this, '#ebebeb')">Contributors Leaderboard</button>
