...
if(isset($_POST['change_button'])){
  ...
  if ($old_entered != $_SESSION['username']){
  ...
  elseif ($new_pass != $new_pass_conf){
    ...
    $update_query = "UPDATE user_details SET username = '$new_pass' WHERE username = '".$_SESSION['username']."'";
    mysqli_query($conn, $update_query);
    $_SESSION['username'] = $new_pass;
    echo '<script type="text/javascript">';
...
<html lang="en">
  <head>
    <title>Terrarium | Edit Profile
    </title>
    <meta
      property="og:title"
      content="Terrarium | Edit Profile"
    />
